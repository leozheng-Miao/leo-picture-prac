...
import com.yupi.yupicture.infrastructure.api.imagesearch.ImageSearchFacade;
...
import com.yupi.yupicture.share.auth.SpaceUserAuthManager;
import com.yupi.yupicture.share.auth.StpKit;
import com.yupi.yupicture.share.auth.annotation.SaSpaceCheckPermission;
...
//            pictureService.checkPictureAuth(loginUser, picture);
        ...
        pictureVO.setPermissionList(permisssionList);
        //获取封装类
        return ResultUtils.success(pictureVO);
    }
...
//            }
    ...
    public BaseResponse<Boolean> doPictureReview(@RequestBody PictureReviewRequest pictureReviewRequest,
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        Picture picture = PictureAssembler.toPictureEntity(pictureReviewRequest);
        picture.setReviewerId(loginUser.getId());
        pictureApplicationService.doPictureReview(picture, loginUser);
        return ResultUtils.success(true);
    ...
    public BaseResponse<Integer> uploadPictureByBatch(@RequestBody PictureUploadByBatchRequest pictureUploadByBatchRequest,
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        int result = pictureApplicationService.uploadPictureByBatch(pictureUploadByBatchRequest, loginUser);
    ...
    public BaseResponse<List<PictureVO>> searchPictureByColor(@RequestBody SearchPictureByColorRequest searchPictureByColorRequest,
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        List<PictureVO> searchPictureByColorList = pictureApplicationService.searchPictureByColor(spaceId, color, loginUser);
    ...
    public BaseResponse<CreateOutPaintingTaskResponse> createPictureOutPaintingTask(@RequestBody CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest,
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        CreateOutPaintingTaskResponse createOutPaintingTaskResponse = pictureApplicationService.createPictureOutPaintingTask(createPictureOutPaintingTaskRequest, loginUser);
