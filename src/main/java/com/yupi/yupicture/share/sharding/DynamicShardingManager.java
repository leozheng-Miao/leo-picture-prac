package com.yupi.yupicture.share.sharding;
...
public class DynamicShardingManager {
    ...
    private Set<String> fetchAllPictureTableNames() {
        ...
        Set<Long> spaceIds = spaceApplicationService.lambdaQuery()
                ...
                .eq(Space::getSpaceLevel, SpaceLevelEnum.FLAGSHIP) // 这里需要判断该空间是否为旗舰空间
                .list()
                .stream()
                .map(Space::getId)
    ...
    private void updateShardingTableNodes() {
        ...
        //拿到ShardingSphere 上下文后，逐级去找我们想要动态管理的字段
        // actual-daya-nodes
